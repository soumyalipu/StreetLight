...
<html lang="en">
<head>
  <?php headContent("EntitySinglephaseList");?>
</head>
...
<?php
	...
	$singlephaseArrayList = $singlephaseModel -> GetAllSinglephase();
?>
<!-- End: Retrive Data-->
...
<div class="container">
	...
	<h3 class="w3-padding w3-blue">Singlephase List<a href="EntitySinglephaseCreate.php"><button class="w3-btn w3-green w3-right w3-small">NEW</button></a></h3>
	<div class="w3-container w3-padding w3-card-2" style="margin-top:-12px;overflow-x:scroll">
		<table class="w3-table-all display" id="example">
			...
			<tbody>
				<?php
				foreach($singlephaseArrayList as $row)
				{
					?>
					<tr>
							...
							<td>
								<a href="EntitySinglephaseDelete.php?ID=<?php echo $row->ID;?>" class="w3-btn w3-red w3-small w3-round">Delete</a>
								<a href="EntitySinglephaseEdit.php?ID=<?php echo $row->ID;?>" class="w3-btn w3-green w3-small w3-round">Edit</a>
							</td>
					</tr>
					<?php
				}
