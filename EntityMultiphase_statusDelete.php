...
<html lang="en">
<head>
  <?php headContent("EntityMultiphase_statusDelete");?>
</head>
			...
			<form method="POST">
				...
				<div class="w3-container w3-card-2" style="margin-top:-12px">
					<div class="form-group">
						...
						<a href="EntityMultiphase_statusList.php" class="w3-btn w3-small w3-round w3-blue" >Back</a>
					</div>
				</div>
			</form>
		</div>
...
<?php
	...
	if($multiphase_statusModel -> DeleteMultiphase_statusById($_GET["ID"]))
	{
		echo '<script>alert("Multiphase_status record deleted successfully.");window.location="EntityMultiphase_statusList.php";</script>';
	}
	else
	{
		echo '<script>alert("Unable to delete Multiphase_status.");window.location="EntityMultiphase_statusList.php";</script>';
	}
	}
?>
<!-- End: Delete Data-->
