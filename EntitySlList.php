...
<div class="container">
	...
	<h3 class="w3-padding w3-blue">Sl List<a href="EntitySlCreate.php"><button class="w3-btn w3-green w3-right w3-small">NEW</button></a></h3>
			...
			<tbody>
				...
				foreach($slArrayList as $row)
				{
					...
					<tr>
							...
							<td>
								<a href="EntitySlDelete.php?ID=<?php echo $row->ID;?>" class="w3-btn w3-red w3-small w3-round">Delete</a>
								<a href="EntitySlEdit.php?ID=<?php echo $row->ID;?>" class="w3-btn w3-green w3-small w3-round">Edit</a>
							</td>
					</tr>
					<?php
				}
