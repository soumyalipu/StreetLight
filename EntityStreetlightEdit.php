...
<html lang="en">
<head>
  <?php headContent("EntityStreetlightEdit");?>
</head>
...
<div class="container">
	<h3 class="w3-padding w3-card-2 w3-blue">Edit Streetlight</h3>
	<div class="w3-card-2 w3-padding " style="margin-top:-12px;overflow-x:scroll" >
		<form method="POST" enctype="multipart/form-data" >
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter ID ..." class="w3-input form-control" name="ID" id="ID"  value="<?php echo $streetlight->ID; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter SL_ID ..." class="w3-input form-control" name="SL_ID" id="SL_ID"  value="<?php echo $streetlight->SL_ID; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter PHASE ..." class="w3-input form-control" name="PHASE" id="PHASE"  value="<?php echo $streetlight->PHASE; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter R_WATT ..." class="w3-input form-control" name="R_WATT" id="R_WATT"  value="<?php echo $streetlight->R_WATT; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter Area ..." class="w3-input form-control" name="Area" id="Area"  value="<?php echo $streetlight->Area; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LONGITUDE ..." class="w3-input form-control" name="LONGITUDE" id="LONGITUDE"  value="<?php echo $streetlight->LONGITUDE; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LATITUDE ..." class="w3-input form-control" name="LATITUDE" id="LATITUDE"  value="<?php echo $streetlight->LATITUDE; ?>" />
			</div>
...
<?php
	if(isset($_POST["submitForm"]))
	{
		...
		if($streetlightModel -> UpdateStreetlight($streetlight))
		{
			 echo '<script>alert("Streetlight updated successfully...");window.location=window.location.href;</script>';
		}
		else
		{
			 echo '<script>alert("Unable to updated Streetlight ...");window.location=window.location.href;</script>';
		}
	}
?>
<!-- End: Edit Form PHP-->
