...
<html lang="en">
<head>
  <?php headContent("EntityAdminCreate");?>
</head>
...
<div class="container">
	<h3 class="w3-padding w3-card-2 w3-blue">Create Admin</h3>
	<div class="w3-card-2 w3-padding " style="margin-top:-12px;overflow-x:scroll" >
		<form method="POST" enctype="multipart/form-data" >
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter ADMINID ..." class="w3-input form-control" name="ADMINID" id="ADMINID"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter ADMINPASS ..." class="w3-input form-control" name="ADMINPASS" id="ADMINPASS"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter ADMINEMAIL ..." class="w3-input form-control" name="ADMINEMAIL" id="ADMINEMAIL"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter ADMINMOBILE ..." class="w3-input form-control" name="ADMINMOBILE" id="ADMINMOBILE"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter ADMINSTATUS ..." class="w3-input form-control" name="ADMINSTATUS" id="ADMINSTATUS"  />
			</div>
...
<?php
	if(isset($_POST["submitForm"]))
	{
		...
		{
			 echo '<script>alert("Admin created successfully...");window.location=window.location.href;</script>';
		}
		else
		{
			 echo '<script>alert("Unable to create Admin ...");window.location=window.location.href;</script>';
		}
	}
?>
<!-- End: Create Form PHP-->
