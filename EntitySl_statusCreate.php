...
<html lang="en">
<head>
  <?php headContent("EntitySl_statusCreate");?>
</head>
...
<div class="container">
	<h3 class="w3-padding w3-card-2 w3-blue">Create Sl_status</h3>
...
<?php
	if(isset($_POST["submitForm"]))
	{
		...
		{
			 echo '<script>alert("Sl_status created successfully...");window.location=window.location.href;</script>';
		}
		else
		{
			 echo '<script>alert("Unable to create Sl_status ...");window.location=window.location.href;</script>';
		}
	}
?>
<!-- End: Create Form PHP-->
