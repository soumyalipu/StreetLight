...
<html lang="en">
<head>
  <?php headContent("EntityMultiphaseCreate");?>
</head>
...
<div class="container">
	<h3 class="w3-padding w3-card-2 w3-blue">Create Multiphase</h3>
	<div class="w3-card-2 w3-padding " style="margin-top:-12px;overflow-x:scroll" >
		<form method="POST" enctype="multipart/form-data" >
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter POWERR ..." class="w3-input form-control" name="POWERR" id="POWERR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter POWERY ..." class="w3-input form-control" name="POWERY" id="POWERY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter POWERB ..." class="w3-input form-control" name="POWERB" id="POWERB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter CURRENTR ..." class="w3-input form-control" name="CURRENTR" id="CURRENTR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter CURRENTY ..." class="w3-input form-control" name="CURRENTY" id="CURRENTY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter CURRENTB ..." class="w3-input form-control" name="CURRENTB" id="CURRENTB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LOW_VOLTR ..." class="w3-input form-control" name="LOW_VOLTR" id="LOW_VOLTR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LOW_VOLTY ..." class="w3-input form-control" name="LOW_VOLTY" id="LOW_VOLTY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LOW_VOLTB ..." class="w3-input form-control" name="LOW_VOLTB" id="LOW_VOLTB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HIGH_VOLTR ..." class="w3-input form-control" name="HIGH_VOLTR" id="HIGH_VOLTR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HIGH_VOLTY ..." class="w3-input form-control" name="HIGH_VOLTY" id="HIGH_VOLTY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HIGH_VOLTB ..." class="w3-input form-control" name="HIGH_VOLTB" id="HIGH_VOLTB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter PFR ..." class="w3-input form-control" name="PFR" id="PFR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter PFY ..." class="w3-input form-control" name="PFY" id="PFY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter PFB ..." class="w3-input form-control" name="PFB" id="PFB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HCR ..." class="w3-input form-control" name="HCR" id="HCR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HCY ..." class="w3-input form-control" name="HCY" id="HCY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter HCB ..." class="w3-input form-control" name="HCB" id="HCB"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LCR ..." class="w3-input form-control" name="LCR" id="LCR"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LCY ..." class="w3-input form-control" name="LCY" id="LCY"  />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter LCB ..." class="w3-input form-control" name="LCB" id="LCB"  />
			</div>
...
<?php
	if(isset($_POST["submitForm"]))
	{
		...
		if($multiphaseModel -> InsertMultiphase($multiphase))
		{
			 echo '<script>alert("Multiphase created successfully...");window.location=window.location.href;</script>';
		}
		else
		{
			 echo '<script>alert("Unable to create Multiphase ...");window.location=window.location.href;</script>';
		}
	}
?>
<!-- End: Create Form PHP-->
