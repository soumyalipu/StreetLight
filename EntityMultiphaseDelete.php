...
<html lang="en">
<head>
  <?php headContent("EntityMultiphaseDelete");?>
</head>
			...
			<form method="POST">
				...
				<div class="w3-container w3-card-2" style="margin-top:-12px">
					<div class="form-group">
						...
						<a href="EntityMultiphaseList.php" class="w3-btn w3-small w3-round w3-blue" >Back</a>
					</div>
				</div>
			</form>
		</div>
...
<?php
	...
	if($multiphaseModel -> DeleteMultiphaseById($_GET["ID"]))
	{
		echo '<script>alert("Multiphase record deleted successfully.");window.location="EntityMultiphaseList.php";</script>';
	}
	else
	{
		echo '<script>alert("Unable to delete Multiphase.");window.location="EntityMultiphaseList.php";</script>';
	}
	}
?>
<!-- End: Delete Data-->
